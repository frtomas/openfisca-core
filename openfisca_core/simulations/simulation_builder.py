...
class SimulationBuilder:
    ...
    def __init__(self):
        ...
        self.populations: Dict[Personifiable.key, Population] = {}
        ...
        self.memberships: Dict[Personifiable.plural, List[int]] = {}
        self.roles: Dict[Personifiable.plural, List[int]] = {}

        self.variable_entities: Dict[Variable.name, Personifiable] = {}

        self.axes = [[]]
        self.axes_entity_counts: Dict[Personifiable.plural, int] = {}
        self.axes_entity_ids: Dict[Personifiable.plural, List[int]] = {}
        self.axes_memberships: Dict[Personifiable.plural, List[int]] = {}
        self.axes_roles: Dict[Personifiable.plural, List[int]] = {}
    ...
    def add_default_group_entity(self, persons_ids, entity):
        ...
        self.memberships[entity.plural] = numpy.arange(0, persons_count, dtype = numpy.int32)
        self.roles[entity.plural] = numpy.repeat(entity.flattened_roles[0], persons_count)
    ...
    def expand_axes(self):
        ...
        for entity_name in self.entity_counts.keys():
            ...
            if entity_name != self.persons_plural:
                ...
                indices = numpy.repeat(numpy.arange(0, cell_count), len(original_memberships)) * self.entity_counts[entity_name]
                adjusted_memberships = (numpy.array(repeated_memberships) + indices).tolist()
